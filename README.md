...
- [Serenity/JS HTML Report](https://serenity-js.github.io/serenity-js-playwright-test-template/serenity-js/)
...
- Example web and REST API test scenarios demonstrating both UI and API testing
...
- **Playwright Test**: `./reports/playwright/index.html`

Alternatively, serve the reports using the built-in commands:
```
npm run test:report
```
...
npm test                # executes the example test suite
                        # and generates reports under ./reports/
npm run test:report     # serves the Serenity/JS report and opens it in the browser
```
...
```
spec/
├── api_testing.spec.ts              # REST API testing examples
├── blended_testing.spec.ts          # Combined API and UI testing
├── multi-actor_scenarios.spec.ts    # Multi-actor scenarios
...
reports/playwright/      # Generated Playwright Test reports
```
...
- Update `baseURL` in [`playwright.config.ts`](playwright.config.ts) to point to your application
- Replace the example tests in `spec/` with scenarios for your own application
